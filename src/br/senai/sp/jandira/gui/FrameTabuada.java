...
public class FrameTabuada {
	...
	public void criarTela() {
		...
		labelTitulo.setBounds(20, 10,100, 30);
		...
		labelSubTitulo.setText( " Com a tabuada 1.0 os seus problemas acabaram. Calcule a tabuada que desejar em segundos!" );
		...
		//String[] carros = {"Gol", "Uno", "Fusca", "Palio", "Monza", "Jeep", "Celta", "Brasilia", "Passat", "Variant"};
